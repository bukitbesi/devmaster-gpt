...
index db7593b91431508933ec256c94f5e36da034eed0..8135332a24bc93e50214580f6a9cdfcaea08e8cc 100644
--- a/tools.py
+++ b/tools.py
@@ -1,90 +1,79 @@
-diff --git a/tools.py b/tools.py
-index 7fe7f04d0c6b085432d884ec36578d324d782c91..3550b1453b69017dcad75ed3dd944289a522126b 100644
---- a/tools.py
-+++ b/tools.py
-@@ -1,50 +1,85 @@
...
-+
-+    This helper performs a GET request and decodes the response as JSON.
-+
-+    Args:
